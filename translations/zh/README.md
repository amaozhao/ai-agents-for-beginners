...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-03T13:53:18+00:00",
...
![初学者生成式AI](../../translated_images/repo-thumbnailv2.06f4a48036fde647f6ba4eb19f5651babe59bb30e972748afb349e47725d7601.zh.png)
...
感谢 [Shivam Goyal](https://www.linkedin.com/in/shivam2003/) 提供了展示代理 RAG 的重要代码示例。
...
本项目可能包含项目、产品或服务的商标或标志。经授权使用 Microsoft 商标或标志需遵守并必须遵循 [Microsoft 商标和品牌指南](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general)。在本项目的修改版本中使用 Microsoft 商标或标志不得引起混淆或暗示 Microsoft 的赞助。任何第三方商标或标志的使用需遵守这些第三方的政策。
